...
int main() {
  ...
  // Simulate round 0: Q is [1, 512], K[0] is [1, 512], V[0] is [1, 512]
  ...
  // Allocate accumulator for answer [1, 512] and move to SRAM
  std::vector<float> empty_data(512, 0.0f);
  sjtu::Matrix* answer = new sjtu::Matrix(1, 512, empty_data, gpu_sim);
  ...
  std::cout << "Done! Answer position: " << (int)answer->GetPosition() << std::endl;
